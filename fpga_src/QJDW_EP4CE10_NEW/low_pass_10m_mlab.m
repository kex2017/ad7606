...
%-----------------------------------------------------------------------------------------------------------
	...
	function  output = low_pass_10m_mlab_mat (stimulation, output)
	coef_matrix=[43 -45 29 0 -34 59 -64 43 0 -53 96 -110 79 0 -119 258 -387 478 2046 478 -387 258 -119 0 79 -110 96 -53 0 43 -64 59 -34 0 29 -45 43 ];
	INTER_FACTOR  = 1;
	DECI_FACTOR  = 1; 
	MSB_RM  = 0;
	MSB_TYPE  = 0;
