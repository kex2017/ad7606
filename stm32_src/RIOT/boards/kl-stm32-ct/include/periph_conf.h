...
/**
 * @ingroup     boards_kl-stm32
 * @{
 *
 * @file
 * @brief       Peripheral MCU configuration for the kl-stm32 board
 *
...
static const adc_conf_t adc_config[] = {
                ...
                {.pin = GPIO_PIN(PORT_C, 1),
                 .dev = 0,
                 .chan = 11,
                },
				{.pin = GPIO_PIN(PORT_C, 2),
				 .dev = 0,
				 .chan = 12,
				}
};
...
static const spi_conf_t spi_config[] = {
	    ...
	    },
    {
        ...
        .cs_pin   = GPIO_PIN(PORT_B, 12),   /*nor spi flash*/
...
#define ENC28J60_PARAM_CS       (GPIO_PIN(PORT_A, 4))
#define ENC28J60_PARAM_INT      (GPIO_PIN(PORT_A, 1))
#define ENC28J60_PARAM_RESET    (GPIO_PIN(PORT_A, 0))
