...
module low_pass_10m (
	...
	low_pass_10m_ast	low_pass_10m_ast_inst(
		.clk(clk),
		.reset_n(reset_n),
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.FIRModelClass"  active_core="low_pass_10m_ast" >
...
// Retrieval info:      <PRIVATE name = "coefficient_scaling_factor" value="2558.769216830809"  type="STRING"  enable="0" />
...
// Retrieval info:      <PRIVATE name = "set_1" value="Low Pass Set, Floating, Low Pass, Rectangular, 37, 2.0E7, 8000000.0, 3750000.0, 0, 0.0168182, -0.0178075, 0.0116935, 0.0, -0.013364, 0.0232868, -0.0252273, 0.0170088, 0.0, -0.0207885, 0.037841, -0.0432469, 0.0311827, 0.0, -0.0467741, 0.100909, -0.151364, 0.187096, 0.799994, 0.187096, -0.151364, 0.100909, -0.0467741, 0.0, 0.0311827, -0.0432469, 0.037841, -0.0207885, 0.0, 0.0170088, -0.0252273, 0.0232868, -0.013364, 0.0, 0.0116935, -0.0178075, 0.0168182"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "logic_cell" value="1802"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "filename" value="low_pass_10m.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
