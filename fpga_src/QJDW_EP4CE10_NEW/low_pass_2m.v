...
module low_pass_2m (
	...
	low_pass_2m_ast	low_pass_2m_ast_inst(
		.clk(clk),
		.reset_n(reset_n),
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.FIRModelClass"  active_core="low_pass_2m_ast" >
...
// Retrieval info:      <PRIVATE name = "coefficient_scaling_factor" value="6374.95810799073"  type="STRING"  enable="0" />
...
// Retrieval info:      <PRIVATE name = "set_1" value="Low Pass Set, Floating, Low Pass, Rectangular, 37, 1.0E8, 1000000.0, 3750000.0, 0, 0.0159673, 0.0163701, 0.0167552, 0.0171217, 0.0174687, 0.0177953, 0.018101, 0.0183849, 0.0186464, 0.0188848, 0.0190997, 0.0192905, 0.0194568, 0.0195982, 0.0197143, 0.0198049, 0.0198697, 0.0199087, 0.0199217, 0.0199087, 0.0198697, 0.0198049, 0.0197143, 0.0195982, 0.0194568, 0.0192905, 0.0190997, 0.0188848, 0.0186464, 0.0183849, 0.018101, 0.0177953, 0.0174687, 0.0171217, 0.0167552, 0.0163701, 0.0159673"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "logic_cell" value="1745"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "filename" value="low_pass_2m.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
