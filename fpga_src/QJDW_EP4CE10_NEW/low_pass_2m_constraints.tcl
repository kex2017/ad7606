...
proc add_fir_constraints {args} {
	...
	set_global_assignment -name "DSP_BLOCK_BALANCING" -remove -entity "low_pass_2m_st"
	...
	set_global_assignment -name "DSP_BLOCK_BALANCING" -entity "low_pass_2m_st" "LOGIC ELEMENTS"
}
add_fir_constraints
